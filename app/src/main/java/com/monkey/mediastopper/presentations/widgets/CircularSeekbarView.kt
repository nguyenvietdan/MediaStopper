package com.monkey.mediastopper.presentations.widgets
...
fun CircularSeekbarView(
    ...
    var sweepAngle = value * fullAngle / maxValue /** fullAngle*/
    if (steps > 0) {
            ...
            when (it.actionMasked) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if (nextSweepAngle/* / fullAngle*/ != value) {
                        onChange(nextSweepAngle * maxValue / fullAngle /*/ fullAngle*/) // todo consider change with var sweepAngle = value /** fullAngle*/
                    }
                }
